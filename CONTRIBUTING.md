...
- Make a local clone of this repo: `git clone git@github.com:tomalec/uni-datepicker.git`

In order to develop it locally we suggest to use [polyserve](https://npmjs.com/polyserve) tool to handle bower paths gently.

0. Go to the repo's directory: `cd uni-datepicker`
...
4. Open the demo/preview: [http://localhost:8000/components/uni-datepicker/](http://localhost:8000/components/uni-datepicker/)
5. Open the test suite: [http://localhost:8000/components/uni-datepicker/test/](http://localhost:8000/components/uni-datepicker/test/)
...
6. Explain the changes (at least an summary of the commit log) in [GitHub Releases](https://github.com/tomalec/uni-datepicker/releases).
